...
namespace fgo::factor {
    ...
    public:
      ...
      PrFactor(gtsam::Key pose_i, gtsam::Key cbd_i, const double &measRho, const gtsam::Vector3& satXYZ, const gtsam::Vector3& lb,
              ...
              {
                factorTypeID_ = FactorTypeIDs::PR;
        ...
        if(useAutoDiff_)
        {
          if (H1) {
            *H1 = gtsam::numericalDerivative21<gtsam::Vector1, gtsam::Pose3, gtsam::Vector2>(
                boost::bind(&This::evaluateError_, this, boost::placeholders::_1, boost::placeholders::_2), pose, cbd, 1e-5);
          }
          if (H2)
