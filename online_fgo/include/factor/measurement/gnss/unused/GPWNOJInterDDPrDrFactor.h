...
class GPWNOJInterpolatedDDPrDrFactor : public NoiseModelFactor8<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
    ...
    public:
      ...
      GPWNOJInterpolatedDDPrDrFactor(const gtsam::Key &point_i, const gtsam::Key &vel_i, const gtsam::Key &omega_i, const gtsam::Key &acc_i,
      ...
      [[nodiscard]] gtsam::Vector2 evaluateError_(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1, const gtsam::Vector6 &acc1,
