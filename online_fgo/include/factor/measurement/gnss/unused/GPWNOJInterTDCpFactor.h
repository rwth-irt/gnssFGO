...
namespace fgo::factor {
    ...
    //Lyu, Bai, Lai, Wang and Huang - Optimal Time Difference-based TDCP-GPS/IMU Navigation using GraphBase Optimization
class GPWNOJInterTDCpFactor : public fgo::NoiseModelFactor8<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
    ...
    public:
      ...
      [[nodiscard]] gtsam::Vector evaluateError(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1, const gtsam::Vector6& acc1,
        ...
        if (H1)
          *H1 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Pose3>(
                  boost::bind(&This::evaluateError_, this, boost::placeholders::_1, vel1, omega1, acc1, pose2, vel2, omega2, acc2),
                  pose1);
        if (H2)
          *H2 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
                  boost::bind(&This::evaluateError_, this, pose1, boost::placeholders::_1, omega1, acc1, pose2, vel2, omega2, acc2),
                  vel1);
        if (H3)
          *H3 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
                  boost::bind(&This::evaluateError_, this, pose1, vel1, boost::placeholders::_1, acc1, pose2, vel2, omega2, acc2),
                  omega1);

        if (H4)
          *H4 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector6>(
                  boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, boost::placeholders::_1, pose2, vel2, omega2, acc2),
                  acc1);

        if (H5)
          *H5 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Pose3>(
                  boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, boost::placeholders::_1, vel2, omega2, acc2),
                  pose2);
        if (H6)
          *H6 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
                  boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, boost::placeholders::_1, omega2, acc2),
                  vel2);
        if (H7)
          *H6 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector3>(
                  boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, boost::placeholders::_1, acc2),
                  omega2);

        if (H8)
          *H8 = gtsam::numericalDerivative11<gtsam::Vector2, gtsam::Vector6>(
                  boost::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, boost::placeholders::_1),
                  acc2);
      ...
      [[nodiscard]] gtsam::Vector evaluateError_(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1, const gtsam::Vector6& acc1,
                                   const gtsam::Pose3 &pose2, const gtsam::Vector3 &vel2, const gtsam::Vector3 &omega2, const gtsam::Vector6& acc2) const {
...
class GPWNOJInterpolated3TDCpFactor : public fgo::NoiseModelFactor12<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Vector6,
    ...
    public:
      ...
      GPWNOJInterpolated3TDCpFactor(gtsam::Key point_i, gtsam::Key vel_i, gtsam::Key omega_i, gtsam::Key acc_i,
                                     ...
                                     const std::shared_ptr<fgo::models::GPInterpolator> &interpolator_i,
                                     const std::shared_ptr<fgo::models::GPInterpolator> &interpolator_j) :
              Interpolator(model, point_i, vel_i, omega_i, acc_i, point_j, vel_j, omega_j, acc_j, point_k, vel_k, omega_k, acc_k),
      ...
      [[nodiscard]] gtsam::Vector evaluateError(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1, const gtsam::Vector6& acc1,
                                                const gtsam::Pose3 &pose2, const gtsam::Vector3 &vel2, const gtsam::Vector3 &omega2, const gtsam::Vector6& acc2,
                                                const gtsam::Pose3 &pose3, const gtsam::Vector3 &vel3, const gtsam::Vector3 &omega3, const gtsam::Vector6& acc3,
                                                boost::optional<gtsam::Matrix &> H1 = boost::none,
                                                boost::optional<gtsam::Matrix &> H2 = boost::none,
                                                boost::optional<gtsam::Matrix &> H3 = boost::none,
                                                boost::optional<gtsam::Matrix &> H4 = boost::none,
        ...
        if (H1)
          *H1 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Pose3>(
                  std::bind(&This::evaluateError_, this, std::placeholders::_1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3, omega3, acc3), pose1);

        if (H2) {
          *H2 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
              std::bind(&This::evaluateError_, this, pose1, std::placeholders::_1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3, omega3, acc3), vel1);
        }

        if (H3) {
          *H3 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
              std::bind(&This::evaluateError_, this, pose1, vel1, std::placeholders::_1, acc1, pose2, vel2, omega2, acc2, pose3, vel3, omega3, acc3), omega1);
        }

        if (H4) {
          *H4 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector6>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, std::placeholders::_1, pose2, vel2, omega2, acc2, pose3, vel3, omega3, acc3), acc1);
        }

        if (H5)
          *H5 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Pose3>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, std::placeholders::_1, vel2, omega2, acc2, pose3, vel3, omega3, acc3), pose2);

        if (H6) {
          *H6 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, std::placeholders::_1, omega2, acc2, pose3, vel3, omega3, acc3), vel2);
        }

        if (H7) {
          *H7 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, std::placeholders::_1, acc2, pose3, vel3, omega3, acc3), omega2);
        }

        if (H8) {
          *H8 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector6>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, std::placeholders::_1, pose3, vel3, omega3, acc3), acc2);
        }

        if (H9)
          *H9 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Pose3>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, std::placeholders::_1, vel3, omega3, acc3), pose3);

        if (H10) {
          *H10 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, std::placeholders::_1, omega3, acc3), vel3);
        }

        if (H11) {
          *H11 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector3>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3, std::placeholders::_1, acc3), omega3);
        }

        if (H12) {
          *H12 = gtsam::numericalDerivative11<gtsam::Vector1, gtsam::Vector6>(
              std::bind(&This::evaluateError_, this, pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3, omega3, std::placeholders::_1), acc3);
        }

        return evaluateError_(pose1, vel1, omega1, acc1, pose2, vel2, omega2, acc2, pose3, vel3, omega3, acc3);
      }

      [[nodiscard]] gtsam::Vector1 evaluateError_(const gtsam::Pose3 &pose1, const gtsam::Vector3 &vel1, const gtsam::Vector3 &omega1, const gtsam::Vector6& acc1,
                                    const gtsam::Pose3 &pose2, const gtsam::Vector3 &vel2, const gtsam::Vector3 &omega2, const gtsam::Vector6& acc2,
                                    const gtsam::Pose3 &pose3, const gtsam::Vector3 &vel3, const gtsam::Vector3 &omega3, const gtsam::Vector6& acc3) const {
