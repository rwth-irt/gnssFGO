...
namespace fgo::factors {
  ...
  public:
    ...
    GPInterDDPRDRFactorWNOJO(const gtsam::Key &point_i, const gtsam::Key &vel_i, const gtsam::Key &omega_i,
                             ...
                             const gtsam::Point3 &pointMaster, const gtsam::Point3 &velMaster,
                             const gtsam::Point3 &pointSatI, const gtsam::Point3 &velSatI, const gtsam::Point3 &pointBase,
                             const gtsam::Point3 &lb, const gtsam::Point3 &angularRate,
    ...
    GPInterDDPRDRFactorWNOJO(const gtsam::Key &point_i, const gtsam::Key &vel_i, const gtsam::Key &omega_i,
            ...
            velMaster_(velMaster), pointSatI_(pointSatI), velSatI_(velSatI), angularRate_(angularRate), GPbase_(interpolator) {}
