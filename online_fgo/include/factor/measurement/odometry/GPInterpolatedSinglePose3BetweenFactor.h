...
class GPInterpolatedSinglePose3BetweenFactor : public fgo::NoiseModelFactor7<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3, gtsam::Vector3,
    ...
    public:
        ...
        GPInterpolatedSinglePose3BetweenFactor(gtsam::Key pose1i, gtsam::Key vel1i, gtsam::Key omega1i,
          ...
          factorTypeID_ = FactorTypeIDs::GPSingleBetweenPose;
...
/// traits
    template<>
    struct traits<fgo::factor::GPInterpolatedSinglePose3BetweenFactor> : public gtsam::Testable<fgo::factor::GPInterpolatedSinglePose3BetweenFactor> {};
